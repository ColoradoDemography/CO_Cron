...
var program = ["CDBG","CSBG","DR","EIAF","GAME","REDI","CTF","FFB","FML","FML_SB106","SAR","SEV_DIST","VFP", "MJ", "SAR Tier 3", "SAR Tier 1", "SAR EoY", "SAR Tier 2", "POMH", "CCPI", "GBMJ", "DCFA", "CDBGED", "CDBGPF", "CHPG", "MS"];
...
var promise1 = new Promise(function(resolve, reject) {
    ...
    request({
        url: 'https://storage.googleapis.com/co-publicdata/competitive2.json',
        json: true
...
var promise2 = new Promise(function(resolve, reject) {
    ...
    request({
        url: 'https://storage.googleapis.com/co-publicdata/formulaic.json',
        json: true
    }, function(error, response, body) {
